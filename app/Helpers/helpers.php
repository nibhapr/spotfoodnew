...
if (! function_exists('trans')) {
    ...
    function trans($key = null, $replace = [], $locale = null)
    {
        ...
        if (strpos($key, 'restaurant') !== false&&$vendor_entity_name!="Restaurant"&&$vendor_entity_name_plural!="Restaurants" /* Also check in the value to change to is not restaurant  */) {
