...
<nav class="navbar navbar-top navbar-expand-md  navbar-dark" id="navbar-main">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          ...
          <?php if((auth()->user()->hasRole('owner')||auth()->user()->hasRole('staff'))&&!config('settings.is_pos_cloud_mode')): ?>
...
<?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>