...
<div id="cartSideNav" class="sidenav-cart sidenav-cart-close notranslate">
    <div class="offcanvas-menu-inner">
        ...
        <div class="minicart-content">
            ...
            <div id="minPrice" value="<?php echo e($minPrice ?? ''); ?>" hidden><?php echo e($minPrice ?? ''); ?></div>
                    ...
                    <div  class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <?php if(isset($doWeHaveMinimumPrice)&&$doWeHaveMinimumPrice): ?>
                                ...
                                <h6 id="showMinPrice" class="text-success"></h6>
                                <?php endif; ?>
                            <?php endif; ?>
                            <div class="row">
                                <div class="col">
...
<div class="modal fade" id="cartmodal" tabindex="-1" aria-labelledby="CheckoutMoal" aria-hidden="true">
                      <div class="modal-dialog modal-fullscreen-md-down modal-lg">
                      <div class="modal-content">
<div class="modal-header"><h5 class="modal-title" id="CheckoutModal">Chut</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
...
<?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/layouts/navbars/cartSideMenu.blade.php ENDPATH**/ ?>