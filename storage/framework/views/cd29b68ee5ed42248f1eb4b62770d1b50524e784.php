        ...
        <div class="header-body text-center mb-1">
            <div class="row justify-content-center">
                <a class="navbar-brand" href="/">
                    ...
                    <img src="<?php echo e(config('global.site_logo')); ?>" width="200" class="thumbnail" alt="...">
                </a>
            </div>
        </div>
    </div>
    
</div><?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/layouts/headers/guest.blade.php ENDPATH**/ ?>