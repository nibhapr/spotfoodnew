    ...
    <?php if(config('app.isqrsaas')&&config('settings.is_whatsapp_ordering_mode')&&!config('settings.is_pos_cloud_mode')): ?>
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('admin.restaurant.visits.index')); ?>">
                <i class="ni ni-calendar-grid-58 text-blue"></i> <?php echo e(__('Table Booking')); ?>
...
<?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/layouts/navbars/menus/owner.blade.php ENDPATH**/ ?>