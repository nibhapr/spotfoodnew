            ...
            <div class="col-lg-5 col-md-7">
                ...
                <script>
                    function loginAs(email) {
                        ...
                        document.getElementById("password").value = "Saakshi_1234";
                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body">
                        <div class="text-center text-muted mb-4">
                            <br />
                       <button type="button" onclick="loginAs('admin@spotfood.in')" class="btn btn-outline-danger">Login as Admin</button><br /><br />
                           <button type="button" onclick="loginAs('saakshicctv@gmail.com')" class="btn btn-outline-success">Login as Owner</button><br /><br />
                ...
                <div class="row mt-3">
                    <div class="col-6">
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-light"style="color:red!important;">
...
<?php echo $__env->make('layouts.app', ['class' => 'bg'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>