                ...
                <?php if(config('app.isqrsaas')): ?>
                  ...
                  <?php if(config('settings.enable_guest_log')): ?>
                    <a href="<?php echo e(route('register.visit',['restaurant_id'=>$restorant->id])); ?>" class="nav-link" style="cursor:pointer;">
                        <i class="fa fa-calendar-plus-o"></i>
                        <span class="nav-link-inner--text"><?php echo e(__('RESERVE YOUR TABLE')); ?></span>
                    </a>
                  <?php endif; ?>
...
<?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/layouts/menu/top_justlogo.blade.php ENDPATH**/ ?>