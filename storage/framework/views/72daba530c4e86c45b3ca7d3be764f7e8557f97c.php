...
<head>
    ...
    <!-- Nucleo Icons -->
    <link href="<?php echo e(asset('custom')); ?>/spot/hamburgers.min.css" rel="stylesheet" />
    <link href="<?php echo e(asset('custom')); ?>/spot/font-awesome.min.css" rel="stylesheet" />
    <link href="<?php echo e(asset('custom')); ?>/spot/iconfont.min.css" rel="stylesheet" />
    <link href="<?php echo e(asset('custom')); ?>/spot/magnific-popup.css" rel="stylesheet" />
    <link href="<?php echo e(asset('custom')); ?>/spot/menu.css" rel="stylesheet" />
    <link href="<?php echo e(asset('custom')); ?>/spot/mmenu.min.css" rel="stylesheet" />
    <link href="<?php echo e(asset('custom')); ?>/spot/style.css" rel="stylesheet" />
     <link href="<?php echo e(asset('custom')); ?>/spot/float-labels.min.css" rel="stylesheet" />
...
<!-- MAIN WRAPPER-->
  <div class="wrapper">
   <!-- HERO -->
   <?php echo $__env->make('social.partials.hero1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <!-- Featured clients -->
   <?php echo $__env->make('social.partials.features1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- FEATURES -->
   <?php echo $__env->make('social.partials.explain1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   <?php echo $__env->make('feautureclients::whatsapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   <?php echo $__env->make('social.partials.pricing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <!-- <?php echo $__env->make('social.partials.banners', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>-->
   <?php echo $__env->make('social.partials.demo1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <!-- FOOTER -->
...
</html><?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/social/home.blade.php ENDPATH**/ ?>