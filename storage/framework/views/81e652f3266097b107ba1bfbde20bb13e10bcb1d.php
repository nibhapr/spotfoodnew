                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e("#".$order->id." - ".$order->created_at->locale(Config::get('app.locale'))->isoFormat('LLLL')); ?></h3>
                            </div>
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/orders/show.blade.php ENDPATH**/ ?>