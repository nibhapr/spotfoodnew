                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <?php if(auth()->user()->hasRole('owner') || auth()->user()->hasRole('staff')): ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php if($item->has_variants==1): ?>
                                            <?php echo $__env->make('partials.toggle',['additionalInfo'=>' Missing variants will have the same price as the item','id'=>'enable_system_variants','name'=>'Enable System Variants (Beta)','checked'=>($item->enable_system_variants==1)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-md-6">
                                    </div>
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/items/edit.blade.php ENDPATH**/ ?>