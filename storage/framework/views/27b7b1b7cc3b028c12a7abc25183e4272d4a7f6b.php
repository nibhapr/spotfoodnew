<div class="row">
    <?php if(isset($coupon)): ?>
        <div class="col-md-3">
            <?php echo $__env->make('partials.input',['class'=>"col-12", 'ftype'=>'input','name'=>"Code",'id'=>"code",'placeholder'=>"",'required'=>true, 'value'=>$coupon->code], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    <?php endif; ?>
    <div class="col-md-3">
        <?php echo $__env->make('partials.input',['class'=>"col-12", 'ftype'=>'input','name'=>"Name",'id'=>"name",'placeholder'=>"Enter code name",'required'=>true, 'value'=>isset($coupon)&&$coupon->name?$coupon->name:""], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <div class="col-md-3">
        <?php if(isset($coupon)): ?>
...
<?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/coupons/form.blade.php ENDPATH**/ ?>