...
<div class="card-body">
    <h6 class="heading-small text-muted mb-4"><?php echo e(__('Restaurant information')); ?></h6>
     ...
     <div class="pl-lg-4">
         ...
         <h4><?php echo e($order->restorant->user->email); ?></h4>
     </div>
     <hr class="my-4" />
 ...
 </div><?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/orders/partials/orderinfo.blade.php ENDPATH**/ ?>