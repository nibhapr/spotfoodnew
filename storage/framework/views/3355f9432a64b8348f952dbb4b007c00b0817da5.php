    ...
    <div class="modal-content">
      <div class="modal-body">
        <div class="py-3 text-center">
          ...
          <h4 class="text-gradient text-danger mt-4"><?php echo e(session('status')); ?></h4>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="close" data-dismiss="modal"><?php echo e(__('close')); ?></button>
      </div>
    </div>
  </div>
</div><?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/social/partials/modals.blade.php ENDPATH**/ ?>