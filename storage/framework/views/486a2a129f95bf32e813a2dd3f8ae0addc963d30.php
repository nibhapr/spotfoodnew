    ...
    <form id="restorant-form" method="post" action="<?php echo e(route('admin.restaurants.update', $restorant)); ?>" autocomplete="off" enctype="multipart/form-data">
        ...
        <?php if(config('app.isft')||true): ?>
            <?php echo $__env->make('partials.fields',['fields'=>[
                ...
                ['ftype'=>'bool','name'=>"Dine-In",'id'=>"self_deliver",'value'=>$restorant->self_deliver == 1 ? "true" : "false"],
...
<?php /**PATH /home/u774496545/domains/gotshi.com/public_html/resources/views/restorants/partials/info.blade.php ENDPATH**/ ?>