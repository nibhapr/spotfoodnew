                    ...
                    @foreach ($category->aitems as $item)
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                            <div class="strip">
                                ...
                                @endif
                                <div class="res_title"><b><a onClick="setCurrentItem({{ $item->id }})" href="javascript:void(0)">{{ __($item->name)}}</a></b></div>
                                <div class="res_description">{{ __($item->short_description)}}</div>
                                <div class="row">
