...
<head>
    ...
    <!-- Nucleo Icons -->
    <link href="{{ asset('custom') }}/spot/hamburgers.min.css" rel="stylesheet" />
    <link href="{{ asset('custom') }}/spot/font-awesome.min.css" rel="stylesheet" />
    <link href="{{ asset('custom') }}/spot/iconfont.min.css" rel="stylesheet" />
    <link href="{{ asset('custom') }}/spot/magnific-popup.css" rel="stylesheet" />
    <link href="{{ asset('custom') }}/spot/menu.css" rel="stylesheet" />
    <link href="{{ asset('custom') }}/spot/mmenu.min.css" rel="stylesheet" />
    <link href="{{ asset('custom') }}/spot/style.css" rel="stylesheet" />
     <link href="{{ asset('custom') }}/spot/float-labels.min.css" rel="stylesheet" />
...
<!-- MAIN WRAPPER-->
  <div class="wrapper">
   <!-- HERO -->
   @include('social.partials.hero1')
 <!-- Featured clients -->
   @include('social.partials.features1')
<!-- FEATURES -->
   @include('social.partials.explain1')
   @include('feautureclients::whatsapp')
   @include('social.partials.pricing')
  <!-- @include('social.partials.banners')-->
   @include('social.partials.demo1')
  <!-- FOOTER -->
